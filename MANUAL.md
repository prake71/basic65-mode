...
Manual command:
Markdownemacs-lisp wird nicht vollständig unterstützt. Die Syntaxhervorhebung basiert auf Markdown.M-x basic65-petscii-insert-codeWeitere Zeilen anzeigen
Xemu Integration
...
### Retro Font Toggle
Markdownemacs-lisp wird nicht vollständig unterstützt. Die Syntaxhervorhebung basiert auf Markdown.M-x basic65-toggle-buffer-fontWeitere Zeilen anzeigen

### Customization
Set paths to external tools:
Markdownemacs-lisp wird nicht vollständig unterstützt. Die Syntaxhervorhebung basiert auf Markdown.(setq basic65-petcat-command "petcat")(setq basic65-xemu-command "xmega65")Weitere Zeilen anzeigen
